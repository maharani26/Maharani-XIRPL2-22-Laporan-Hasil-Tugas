...
<html lang="en" dir="ltr">
	...
	<body style="margin-top: 90px; margin-left:250px; background-image: url(<?=base_url()?>assets/bg/p.png); background-size:cover;">

		<h1>KATALOG SPORT.ID</h1>
		...
		<table class="table table-hover table-stripped">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php if($this->session->userdata('level')=="admin"){?>
					<a href="<?=base_url('index.php/sepeda/hapus/'.$bk->kode_sepeda)?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus?')"
					...
					<div class="modal-body">
						...
						<form action="<?=base_url('index.php/sepeda/update')?>" method="post" enctype="multipart/form-data">
							...
							<table>
								...
								<tr>
									<td>Merk</td>
									<td><input type="text" name="merk"   id="merk" style="margin-left: 20px;"></td>
								</tr>
